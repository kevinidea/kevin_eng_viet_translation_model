...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2, no_char_decoder=False):
        ...
        # To calculate how many parameters in the ModelEmbeddings, do this
        # sum([param.numel() for param in self.model_embeddings_source.parameters() if param.requires_grad])
    ...
    def forward(self, source: List[List[str]], target: List[List[str]]) -> torch.Tensor:
        ...
        # to_input_tensor_char has shape (max_sentence_length, batch_size, max_word_length)
